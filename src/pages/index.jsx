...
function Index() {
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="relative text-white bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('public/imges/ChatGPT Image May 20, 2026, 11_12_45 AM.png')" }}>
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-16">
            <div className="relative w-full lg:w-1/2 h-auto lg:h-155">
              ...
              <div className="hidden lg:block relative h-155">
                <img src="public/imges/Screenshot 2026-05-13 163206.png" alt="" className="absolute left-8 bottom-10 w-62.5 h-120 object-cover rounded-[35px] shadow-2xl" />
                <img src="public/imges/Screenshot 2026-05-13 163200.png" alt="" className="absolute left-75 top-0 w-62.5 h-120 object-cover rounded-[35px] shadow-2xl" />
              </div>
            </div>
      ...
      <section ref={statsRef} className="stats-section relative py-28 overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('public/imges/ChatGPT Image May 14, 2026, 10_42_22 AM.png')" }}>
          <div className="absolute inset-0 bg-black/60"></div>
        </div>
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
            <div>
              <img src="public/icons/management.png" className="w-16 h-16 mx-auto mb-8 invert" />
            ...
            <div>
              <img src="public/icons/support.png" className="w-16 h-16 mx-auto mb-8 invert" /> 
            ...
            <div>
              <img src="public/icons/costumer.png" className="w-16 h-16 mx-auto mb-8 invert" />
            ...
            <div>
              <img src="public/icons/anniversary.png" className="w-16 h-16 mx-auto mb-8 invert" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
            ...
            <div className="flex flex-col bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:border-amber-200 group">
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-100">
                ...
                <img src="public/icons/servies.png" alt="الاستشارات الهندسية" className="w-12 h-12 object-contain" />
              </div>
            ...
            <div className="flex flex-col bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:border-amber-200 group">
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-100">
                ...
                <img src="public/icons/management.png" alt="المساحة وفرز الأراضي" className="w-12 h-12 object-contain" />
              </div>
              <p className="text-gray-700 font-semibold mb-4 text-sm">
            ...
            <div className="flex flex-col bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300 hover:border-amber-200 group">
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-100">
                ...
                <img src="public/icons/fire-extinguisher.png" alt="السلامة والرخص" className="w-12 h-12 object-contain" />
              </div>
              <p className="text-gray-700 font-semibold mb-4 text-sm">
      ...
      {/* Shomoul picture */}
      <section>
        <img src="public/imges/ChatGPT Image May 20, 2026, 04_29_10 PM.png" loading="lazy" alt="مجموعة شمول من الداخل" className="w-full max-h-197.5 object-cover block" />
      </section>
        ...
        <div className="overflow-hidden w-full relative">
          <div className="slider-track">
            <div className="shrink-0 w-56 h-32 bg-white rounded-xl shadow flex items-center justify-center p-5 border border-gray-100">
              <img src="public/alhayat/مركز التحكيم التجاري لدول مجلس التعاون الخليجي.jpg" loading="lazy" alt="هيئة" className="max-w-full max-h-full object-contain" />
            </div>
            <div className="shrink-0 w-56 h-32 bg-white rounded-xl shadow flex items-center justify-center p-5 border border-gray-100">
              <img src="public/alhayat/بلدي.jpg" loading="lazy" alt="بلدي" className="max-w-full max-h-full object-contain" />
            </div>
            <div className="shrink-0 w-56 h-32 bg-white rounded-xl shadow flex items-center justify-center p-5 border border-gray-100">
              <img src="public/alhayat/Sabic.jpg" loading="lazy" alt="Sabic" className="max-w-full max-h-full object-contain" />
            </div>
            <div className="shrink-0 w-56 h-32 bg-white rounded-xl shadow flex items-center justify-center p-5 border border-gray-100">
              <img src="public/alhayat/Sap.jpg" loading="lazy" alt="SAP" className="max-w-full max-h-full object-contain" />
            </div>
            <div className="shrink-0 w-56 h-32 bg-white rounded-xl shadow flex items-center justify-center p-5 border border-gray-100">
              <img src="public/alhayat/مدن .jpg" loading="lazy" alt="مدن" className="max-w-full max-h-full object-contain" />
            </div>
            <div className="shrink-0 w-56 h-32 bg-white rounded-xl shadow flex items-center justify-center p-5 border border-gray-100">
              <img src="public/alhayat/Tasnee.jpg" loading="lazy" alt="Tasnee" className="max-w-full max-h-full object-contain" />
            </div>
            <div className="shrink-0 w-56 h-32 bg-white rounded-xl shadow flex items-center justify-center p-5 border border-gray-100">
              <img src="public/alhayat/شركة المياه الوطنية.jpg" loading="lazy" alt="المياه" className="max-w-full max-h-full object-contain" />
            </div>
            <div className="shrink-0 w-56 h-32 bg-white rounded-xl shadow flex items-center justify-center p-5 border border-gray-100">
              <img src="public/alhayat/وزارة الدفاع السعودي.jpg" loading="lazy" alt="الدفاع" className="max-w-full max-h-full object-contain" />
            </div>
            <div className="shrink-0 w-56 h-32 bg-white rounded-xl shadow flex items-center justify-center p-5 border border-gray-100">
              <img src="public/alhayat/مركز التحكيم التجاري لدول مجلس التعاون الخليجي.jpg" loading="lazy" alt="هيئة" className="max-w-full max-h-full object-contain" />
            </div>
      ...
      <section className="relative flex items-center justify-center text-center text-white" 
        style={{ height: '60vh', minHeight: '400px', backgroundImage: "url('public/imges/ChatGPT Image Jun 30, 2026, 11_44_24 AM.png')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
        <div className="absolute inset-0 bg-black/60"></div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
            <div className="flex justify-center">
              <div className="w-32 h-32 bg-white rounded-full shadow-lg flex items-center justify-center p-3 border border-gray-200 hover:scale-110 transition-transform">
                <img src="public/clients/001-1.jpg" alt="عميل" className="max-w-[75%] max-h-[75%] object-contain" />
              </div>
            </div>
            <div className="flex justify-center">
              <div className="w-32 h-32 bg-white rounded-full shadow-lg flex items-center justify-center p-3 border border-gray-200 hover:scale-110 transition-transform">
                <img src="public/clients/002-1.jpg" alt="عميل" className="max-w-[75%] max-h-[75%] object-contain" />
              </div>
            </div>
            <div className="flex justify-center">
              <div className="w-32 h-32 bg-white rounded-full shadow-lg flex items-center justify-center p-3 border border-gray-200 hover:scale-110 transition-transform">
                <img src="public/clients/003-1.jpg" alt="عميل" className="max-w-[75%] max-h-[75%] object-contain" />
              </div>
            </div>
            <div className="flex justify-center">
              <div className="w-32 h-32 bg-white rounded-full shadow-lg flex items-center justify-center p-3 border border-gray-200 hover:scale-110 transition-transform">
                <img src="public/clients/004-2.jpg" alt="عميل" className="max-w-[75%] max-h-[75%] object-contain" />
              </div>
            </div>
            <div className="flex justify-center">
              <div className="w-32 h-32 bg-white rounded-full shadow-lg flex items-center justify-center p-3 border border-gray-200 hover:scale-110 transition-transform">
                <img src="public/clients/006-1.jpg" alt="عميل" className="max-w-[75%] max-h-[75%] object-contain" />
              </div>
            </div>
            <div className="flex justify-center">
              <div className="w-32 h-32 bg-white rounded-full shadow-lg flex items-center justify-center p-3 border border-gray-200 hover:scale-110 transition-transform">
                <img src="public/clients/007-1.png" alt="عميل" className="max-w-[75%] max-h-[75%] object-contain" />
              </div>
            </div>
            <div className="flex justify-center">
              <div className="w-32 h-32 bg-white rounded-full shadow-lg flex items-center justify-center p-3 border border-gray-200 hover:scale-110 transition-transform">
                <img src="public/clients/008-1.jpg" alt="عميل" className="max-w-[75%] max-h-[75%] object-contain" />
              </div>
            </div>
            <div className="flex justify-center">
              <div className="w-32 h-32 bg-white rounded-full shadow-lg flex items-center justify-center p-3 border border-gray-200 hover:scale-110 transition-transform">
                <img src="public/clients/009-1.jpg" alt="عميل" className="max-w-[75%] max-h-[75%] object-contain" />
              </div>
            </div>
            <div className="flex justify-center">
              <div className="w-32 h-32 bg-white rounded-full shadow-lg flex items-center justify-center p-3 border border-gray-200 hover:scale-110 transition-transform">
                <img src="public/clients/010-1.jpg" alt="عميل" className="max-w-[75%] max-h-[75%] object-contain" />
              </div>
            </div>
            <div className="flex justify-center">
              <div className="w-32 h-32 bg-white rounded-full shadow-lg flex items-center justify-center p-3 border border-gray-200 hover:scale-110 transition-transform">
                <img src="public/clients/011.jpg" alt="عميل" className="max-w-[75%] max-h-[75%] object-contain" />
              </div>
            </div>
            <div className="flex justify-center">
              <div className="w-32 h-32 bg-white rounded-full shadow-lg flex items-center justify-center p-3 border border-gray-200 hover:scale-110 transition-transform">
                <img src="public/clients/025.jpg" alt="عميل" className="max-w-[75%] max-h-[75%] object-contain" />
              </div>
            </div>
            <div className="flex justify-center">
              <div className="w-32 h-32 bg-white rounded-full shadow-lg flex items-center justify-center p-3 border border-gray-200 hover:scale-110 transition-transform">
                <img src="public/clients/013.jpg" alt="عميل" className="max-w-[75%] max-h-[75%] object-contain" />
              </div>
            </div>
          </div>
        </div>
